		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Grade II</h1>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/2Maths.pdf" target="_new" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/2PlayToLearn.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/2Eng.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
