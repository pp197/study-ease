		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Grade V</h1>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/5Maths.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/5Evs.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/5Eng.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/5Hindi.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
					<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/5Marathi.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
			</div>
