		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Grade I</h1>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<p>the abstract science of number, quantity, and space, either as abstract concepts ( pure mathematics ), or as applied to other disciplines.
							</p>
							<span><a href="std2.php?file=class/1Maths.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/1Eng.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
					<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/1Marathi.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
			</div>
