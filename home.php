...
<html>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(covernew.jpg);">
			   			...
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>The Roots of Education are Bitter, But the Fruit is Sweet</h1>
									<h2>Brought to you by <a href="#" target="_blank">Study Ease</a></h2>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<p>We offer a wide range of subject categories for student all over world. With the books written by people who master their following field subject.</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>History is the study of change and development in society over time. The study of history enables us to understand Past.</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Algebra, Amusements, Calculus, Combinatorics, Complex Analysis, Constants and Numerical Sequences, Differential Equations, Elliptic Function.</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p> (Physics, Chemistry, Mathematics), PCB (Physics, Chemistry, Biology), and PCMB (Physics, Chemistry, Mathematics, Biology).</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Hindi (Devanagari: हिन्दी), or more precisely Modern Standard Hindi , is an Indo-Aryan language spoken chiefly in North India. </p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							...
							<p>Marathi is an Indo-Aryan language spoken predominantly by Marathi people of Maharashtra, India.</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 text-center animate-box">
				...
				<div class="col-md-10 col-md-offset-1">
					<div class="row">
						<!-- <div class="col-md-3 col-sm-6 text-center animate-box">
							...
							<span class="fh5co-counter js-counter" data-from="0" data-to="329" data-speed="5000" data-refresh-interval="50"></span>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									...
									<span>Rita Jones<br><small>Students</small></span>
									<blockquote>
