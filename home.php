...
<!-- Navbar (sit on top) -->
<div class="w3-top">
   <img src="study.png" alt="logo" id="logoImage">
    <!-- Right-sided navbar links -->

    <div class="w3-right w3-hide-small">
      <a href="#about" class="w3-bar-item w3-button">HOME</a>
      <a href="#team" class="w3-bar-item w3-button"><i class="fa fa-user"></i>CLASS</a>
      <a href="#work" class="w3-bar-item w3-button"><i class="fa fa-th"></i> SUBJECT</a>
      <a href="#pricing" class="w3-bar-item w3-button"><i class="fa fa-usd"></i> TEXTBOOK</a>
      <a href="#contact" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i> MUSIC</a>
    </div>
...
<div class="w3-container" style="padding:128px 16px" id="about">
  ...
  <p class="w3-center w3-large">StudyEase helps you study well in order to conquer all your dreams</p>
