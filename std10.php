		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">Grade X</h1>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<p>the abstract science of number, quantity, and space, either as abstract concepts ( pure mathematics ), or as applied to other disciplines such as physics and engineering.
							</p>
							<span><a href="std2.php?file=class/10Maths.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<p>Science (from Latin scientia 'knowledge') is a systematic enterprise that builds and organizes knowledge in the form of testable explanations and predictions about the world.</p>
							<span><a href="std2.php?file=class/10Sci.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/10English.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="#" class="course-img" style="background-image: url(images/history.jpg);">
						</a>
						<div class="desc">
							<h3><a href="#">History</a></h3>
							<p>“History is the study of change and development in society over time. The study of history enables us to understand how past human action affects the present and influences our future</p>
							<span><a href="std2.php?file=class/10History.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="#" class="course-img" style="background-image: url(images/geo.png);">
						</a>
						<div class="desc">
							<h3><a href="#">Geography</a></h3>
							<p>Geography is the study of places and the relationships between people and their environments. Geographers explore both the physical</p>
							<span><a href="std2.php?file=class/10Geo.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="#" class="course-img" style="background-image: url(images/hindi.jpg);">
						</a>
						<div class="desc">
							<h3><a href="#">Hindi</a></h3>
							<p>Hindi, or more precisely Modern Standard Hindi, is an Indo-Aryan language spoken chiefly in North India. Hindi has been described as a standardised and Sanskritised</p>
							<span><a href="std2.php?file=class/10Hindi.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
					<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							...
							<span><a href="std2.php?file=class/10Marathi.pdf" class="btn btn-primary btn-sm btn-course">Download</a></span>
						</div>
					</div>
				</div>
			</div>
